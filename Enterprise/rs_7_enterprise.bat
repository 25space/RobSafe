...
set maincolor=1f
cls
title mdct Group RobSafe 7 Enterprise
color %maincolor%
cls
...
rem ++++++++++++++++++++++++++++++++++           WICHTIG          ++++++++++++++++++++++++++++++++++
cls
echo mdct Group RobSafe Se7en Enterprise (7) - Edition 180317
echo ######################################################################
echo.
echo.
...
:settings
cls
echo mdct Group RobSafe Se7en Enterprise (7)
echo ######################################################################
echo.
echo.
echo ###############################################
...
echo ###############################################
echo ##   Source (IP):      ##   %ipquelle%
echo ###############################################
echo ##   Source:           ##   %quelle%
echo ###############################################
echo ##   Destination (IP): ##   %ipziel%
echo ###############################################
...
color %maincolor%
cls
title mdct Group RobSafe 7 Enterprise - RUNNING
robocopy %quelle% %ziel%\%date% %parameter% /LOG+:C:\reports\RobsafeReport_%name%_%date%_%remark%.%reportfile%
title mdct Group RobSafe 7 Enterprise - LAST RUNNING %Date% %Time%
echo
cls
echo.
...
:error
color cf
title mdct Group RobSafe 7 Enterprise - ERROR
cls
echo.
