...
color 1f
title mdct Group RobSafe Se7en Stick - %name%
cls
echo mdct Group RobSafe Se7en Stick (7) - Edition 090317
echo ######################################################################
echo.
echo.
...
echo.
echo mdct Group RobSafe 7 Stick
echo.
...
pause
exit
rem GNU GPL V3 Lizenz // mdct Group
rem Made in Germany
